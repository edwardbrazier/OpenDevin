...
class VantagePointAgent(Agent):
    VERSION = '1.6'
    """
    The Vantage Point Agent is based on the CodeActAgent, but with the additional capability of asking the OmniscientChatBot questions about the codebase for a bigger-picture perspective.
    ...
    3. **Consult OmniscientChatBot**: Leverage the OmniscientChatBot to get a big-picture view of the code and task.

    ![image](https://github.com/OpenDevin/OpenDevin/assets/38853559/92b622e3-72ad-4a61-8f41-8c040b6d5fb3)

    ### Plugin System

    To make the VantagePoint agent more powerful with only access to `bash` action space, VantagePoint agent leverages OpenDevin's plugin system:
    ...
    def __init__(
        ...
        """
        Initializes a new instance of the VantagePointAgent class.
    ...
    def reset(self) -> None:
        """
        Resets the VantagePoint Agent.
        """
        super().reset()

    def step(self, state: State) -> Action:
        """
        Performs one step using the VantagePoint Agent.
        This includes gathering info on previous steps, prompting the model to make a command to execute, and consulting the OmniscientChatBot for a big-picture view.
